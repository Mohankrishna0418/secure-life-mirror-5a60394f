import { Bird, Phone } from "lucide-react";
  ...
  <>
    <ServicePageTemplate
      ...
      cards={[
        ...
        {
          title: "Windows",
          desc: "Prevent birds from entering through windows",
        },
        {
          title: "Terraces",
          desc: "Protect your terrace garden and furniture",
        },
        { title: "Duct Areas", desc: "Cover AC ducts and utility areas" },
        {
          title: "Parking Areas",
          desc: "Protect vehicles from bird droppings",
        },
        {
          title: "Warehouses",
          desc: "Industrial-grade protection for large spaces",
        },
      ]}
